...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['boom', 'screen goes boom'],
		['boom2', 'screen goes back to normal'],
		['screenshake', 'stuff'],
		['screenshakehalf', 'stuff'],
		['stuffshake', 'stuff'],
		['stuffshakehalf', 'stuff'],
		['stuffmove', "Value 1: direction\n"],
		['left', "stuff for left-for-dead"],
		['leftback', "reverse"],
		['Lights', "Value 1: 0 = Turn off, 1 = Blue, 2 = Green,\n3 = Pink, 4 = Red, 5 = Orange, Anything else = Random."],
		['ooh', "does stuff to the enemy!"],
		['3,2,1', "go!"],
	];
	...
	**/
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('allofthem'));
		bg.scrollFactor.set();
		bg.color = 0xFF222222;
		add(bg);
