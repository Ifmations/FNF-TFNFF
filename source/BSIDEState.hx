...
class BSIDEState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bgYellow:FlxSprite = new FlxSprite(1000, 1056).makeGraphic(FlxG.width, 386, FlxColor.BLUE);
		bgSprite = new FlxSprite(0, 56);
		bgSprite.antialiasing = ClientPrefs.globalAntialiasing;

        var bg:FlxSprite = new FlxSprite(FlxG.width * 0, bgSprite.y + -10).loadGraphic(Paths.image('storybg'));  
		...
		for (i in 0...CoolUtil.difficultyStuff.length) {
			var sprDifficulty:FlxSprite = new FlxSprite(leftArrow.x + -300, leftArrow.y).loadGraphic(Paths.image('menudifficulties/' + CoolUtil.difficultyStuff[i][0].toLowerCase()));
	...
	override function update(elapsed:Float)
	{
        ...
        {
			PlayState.SONG = Song.loadFromJson('neo-caged', 'neo-caged');
	...
	function updateText()
	{
		...
		txtTracklist.x -= FlxG.width * 0.03;
