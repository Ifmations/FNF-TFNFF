...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resume', 'Restart Song', 'crash game', 'Change Difficulty', 'Toggle Practice Mode', 'Botplay', 'Exit to menu'];
	...
	public function new(x:Float, y:Float)
	{
		...
		var missesTxt:FlxText = new FlxText(20, 15 + 128, 0, "", 32);
